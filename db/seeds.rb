...
original_data = %q(1. Call me Ishmael. -Herman Melville, Moby-Dick (1851)

2. It is a truth universally acknowledged, that a single man in possession of a good fortune, must be in want of a wife. -Jane Austen, Pride and Prejudice (1813)

3. A screaming comes across the sky. -Thomas Pynchon, Gravity's Rainbow (1973)

4. Many years later, as he faced the firing squad, Colonel Aureliano Buendia was to remember that distant afternoon when his father took him to discover ice. -Gabriel Garcia Márquez, One Hundred Years of Solitude (1967; trans. Gregory Rabassa)
...
# sentences = original_data.map do |quote|
#   /\. (?<sentence>.*)-/.match(quote)
# end

# sentences.compact!

# sentences = sentences.map do |quote|
#   quote[1].split("-")[0].strip
# end
